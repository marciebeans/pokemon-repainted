...
const u8 gText_BatteryRunDry[] = _("If your age is on the cock,\pyou're too young for that clock.");
...
const u8 gText_BirchBoy[] = _("BOI");
const u8 gText_BirchGirl[] = _("GRILL");
...
const u8 gText_ThisIsAPokemon[] = _("Is this a pigeon?{PAUSE 96}\p");
...
const u8 gText_SizeComparedTo[] = _("POLICE LINEUP WITH ");
...
const u8 gText_DexHoennTitle[] = _("DAMYEN DEX");
const u8 gText_DexNatTitle[] = _("NATIONAL DEX");
const u8 gText_DexSortNumericalTitle[] = _("THE ACTUAL ORDER");
const u8 gText_DexSortAtoZTitle[] = _("LEARN YOUR ABCs");
const u8 gText_DexSortHeaviestTitle[] = _("BIG BIG CHUNGUS");
const u8 gText_DexSortLightestTitle[] = _("GLASS JOE");
const u8 gText_DexSortTallestTitle[] = _("BASKETBALL PLAYERS");
const u8 gText_DexSortSmallestTitle[] = _("SHORT KINGS");
...
const u8 gText_DexHoennDescription[] = _("Friendly neighborhood Pokédex");
const u8 gText_DexNatDescription[] = _("Pls come to brazil");
const u8 gText_DexSortNumericalDescription[] = _("Choose this one, stupid!");
const u8 gText_DexSortAtoZDescription[] = _("What do you think this is, Sesame\Street?");
const u8 gText_DexSortHeaviestDescription[] = _("Big, big chungus!\nBig chungus, big chungus!");
const u8 gText_DexSortLightestDescription[] = _("Float like a Garneetle, sting like\na Beesquare.");
const u8 gText_DexSortTallestDescription[] = _("For the eventual crossover between\nPokémon and Air Bud.");
const u8 gText_DexSortSmallestDescription[] = _("Small bastards");
const u8 gText_DexEmptyString[] = _("");
const u8 gText_DexSearchDontSpecify[] = _("IDGAF");
...
const u8 gText_HOFDexRating[] = _("Confirmed Sightings: {STR_VAR_1}!\nPokémon Hoard: {STR_VAR_2}!\pProf. Andy's Pokédex rating!\pProf. Andy: Let's see…\p");
...
const u8 gText_IDNumber[] = _("SSID");
const u8 gText_BirchInTrouble[] = _("Prof. Andy is fucked!\nPick your poison and and rescue him!");
...
const u8 gMenuText_Toss[] = _("Yeet");
const u8 gMenuText_Register[] = _("Register");
const u8 gMenuText_Give[] = _("Give");
const u8 gMenuText_CheckTag[] = _("Take a Whiff");
...
const u8 gMenuText_Check[] = _("Czech");
const u8 gText_None[] = _("None");
const u8 gMenuText_Deselect[] = _("shit go back");
...
const u8 gText_CantStoreImportantItems[] = _("Ha ha, very\nfunny.");
const u8 gText_TooImportantToToss[] = _("Ha ha, very\nfunny.");
...
const u8 gText_DadsAdvice[] = _("UR MOM's advice…\n{PLAYER}, there's a time and place for\leverything!\nStop fucking around!{PAUSE_UNTIL_PRESS}");
const u8 gText_CantDismountBike[] = _("Get your ass back on that seat.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_RepelEffectsLingered[] = _("You already did\nthat, stupid!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_TheBattle[] = _("the war");
const u8 gText_ThePokemonList[] = _("the Pokémon LIST");
const u8 gText_TheShop[] = _("the Walmart");
const u8 gText_ThePC[] = _("the gaming PC");
...
const u8 gText_BerriesPocket[] = _("Fruity");
...
const u8 gBerryFirmnessString_VerySoft[] = _("Flaccid");
const u8 gBerryFirmnessString_Soft[] = _("Soft");
const u8 gBerryFirmnessString_Hard[] = _("Hard UwU");
const u8 gBerryFirmnessString_VeryHard[] = _("Erect");
const u8 gBerryFirmnessString_SuperHard[] = _("Expand Dong");

const u8 gText_NumberVar1Var2[] = _("{NO}{STR_VAR_1} {STR_VAR_2}");
const u8 gText_BerryTag[] = _("Gamer Tag");
const u8 gText_RedPokeblock[] = _("Red {POKEBLOCK}");
const u8 gText_BluePokeblock[] = _("Bleu {POKEBLOCK}");
...
const u8 gText_PurplePokeblock[] = _("Blurple {POKEBLOCK}");
...
const u8 gText_OlivePokeblock[] = _("Vomit {POKEBLOCK}");
...
const u8 gText_SoldOut[] = _("TMs are reusable in this game lol.\p");
const u8 gText_SoldOut2[] = _("Sold Out");
const u8 gText_InBagVar1[] = _("IN BAG: {STR_VAR_1}");
const u8 gText_QuitShopping[] = _("Quit shopping.");
const u8 gText_Var1CertainlyHowMany[] = _("{STR_VAR_1}? You want it?\nIt's yours, my friend.");
const u8 gText_Var1CertainlyHowMany2[] = _("{STR_VAR_1}? You want it?\nIt's yours, my friend.");
...
const u8 gText_YouDontHaveMoney[] = _("Come back when you're a\nlittle... mmm, richer!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ICanPayVar1[] = _("Best I can do is ¥{STR_VAR_1}.");
const u8 gText_TurnedOverVar1ForVar2[] = _("Forked over the {STR_VAR_2}\nand received ¥{STR_VAR_1}.");
...
const u8 gText_Enter[] = _("Mr. Enter");
const u8 gText_NoEntry[] = _("shit go back");
const u8 gText_Take2[] = _("Yoink");
...
const u8 gText_PkmnCantSwitchOut[] = _("{STR_VAR_1} can't be switched\nout! It's a trap!{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnAlreadyInBattle[] = _("That's already here,\nstupid!{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnAlreadySelected[] = _("{STR_VAR_1} has already been\nselected.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnHasNoEnergy[] = _("{STR_VAR_1} is fucking dead. {PAUSE_UNTIL_PRESS}");
const u8 gText_CantSwitchWithAlly[] = _("That's probably considered\nstealing...?{PAUSE_UNTIL_PRESS}");
const u8 gText_EggCantBattle[] = _("Egg!!???{PAUSE_UNTIL_PRESS}");
const u8 gText_CantUseUntilNewBadge[] = _("This can't be used until a new\nBADGE is obtained.{PAUSE_UNTIL_PRESS}");
const u8 gText_NoMoreThanVar1Pkmn[] = _("{STR_VAR_1}.\nTake it or leave it.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_MailMessageWillBeLost[] = _("The message will be lost.\nDo you even care?");
...
const u8 gText_CantSurfHere[] = _("Where's my water?");
const u8 gText_AlreadySurfing[] = _("Yes, that's happening.");
...
const u8 gText_ChoosePokemonCancel[] = _("Choose Pokémon or perish.");
...
const u8 gText_NotAble[] = _("Ablen't");
const u8 gText_Able3[] = _("Able!");
const u8 gText_NotAble2[] = _("Fat Chance!");
...
ALIGNED(4) const u8 gText_ThatIsntAnEgg[] = _("Am I a joke to you?");
...
const u8 gText_Power[] = _("Powah");
const u8 gText_Accuracy2[] = _("Accuracy");
const u8 gText_Appeal[] = _("Jelly");
...
const u8 gText_Petalburg[] = _("Hammer");
const u8 gText_Slateport[] = _("Clevelan");
...
const u8 gText_Dewford[] = _("Berferfa");
const u8 gText_Enter2[] = _("Enter");
const u8 gText_Info2[] = _("INFO");
const u8 gText_WhatsAContest[] = _("owO, what's this?");
const u8 gText_TypesOfContests[] = _("Literally what");
...
const u8 gText_NavelRock[] = _("Cave of the Past");
const u8 gText_ClawFossil[] = _("Chord Fossil");
const u8 gText_RootFossil[] = _("Arm Fossil");
...
const u8 gText_ByeByePkmn[] = _("Begone, thot!");
const u8 gText_MarkYourPkmn[] = _("Mark your plier.");
const u8 gText_ThatsYourLastPkmn[] = _("Party of one.");
...
const u8 gText_WasItWorriedAboutYou[] = _("That's kinda cringe, innit?");
...
const u8 gPCText_Release[] = _("Banish");
const u8 gPCText_Mark[] = _("Oh Hi Mark");
const u8 gPCText_Name[] = _("Rename");
...
const u8 gText_WithdrawMonDescription[] = _("Let them out! Let them out!");
const u8 gText_DepositMonDescription[] = _("Put that thing back where it\ncame from, or so help me!");
...
const u8 gText_SeeYaDescription[] = _("Get on with it!");
...
const u8 gText_NothingChanged[] = _("Wow, look! Nothing");
...
const u8 gText_Excellent[] = _("Poggers");
const u8 gText_SoSo[] = _("So-so");
const u8 gText_Bad[] = _("Bad");
const u8 gText_TheWorst[] = _("Shite");
...
const u8 gText_TrainerCardIDNo[] = _("SSID");
...
const u8 gText_MenuPokenav[] = _("lol");
const u8 gText_MenuPlayer[] = _("{PLAYER}");
const u8 gText_MenuSave[] = _("Save");
const u8 gText_MenuOption[] = _("Options");
const u8 gText_MenuExit[] = _("Stop It");
const u8 gText_MenuRetire[] = _("Touch Grass");
const u8 gText_MenuRest[] = _("Go Sleep");
...
const u8 gText_YourName[] = _("You're Name?");
...
const u8 gText_YouveGot9999Coins[] = _("Stonks.");
const u8 gText_YouveRunOutOfCoins[] = _("Haha bankruptcy\ngo brrrr");
...
const u8 gDaycareText_GetAlongVeryWell[] = _("These two FUCK.\nIt's nasty.");
const u8 gDaycareText_GetAlong[] = _("Chillin out, maxin', relaxin',\nall cool.");
...
const u8 gText_MoveRelearnerContestMovesTitle[] = _("Useless Moves");
const u8 gText_MoveRelearnerType[] = _("Type/"); // Unused
const u8 gText_MoveRelearnerPP[] = _("PP/");
const u8 gText_MoveRelearnerPower[] = _("Kono Powah/");
const u8 gText_MoveRelearnerAccuracy[] = _("Accuracy/");
const u8 gText_MoveRelearnerAppeal[] = _("Jelly");
...
const u8 gText_DelAll[] = _("Delet This");
